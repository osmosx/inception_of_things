...
export EMAIL="nenvoy@42.fr"
export DOMAIN="gitlab.nenvoy.com"
...
kubectl port-forward --address 0.0.0.0 svc/gitlab-webservice-default -n gitlab 8085:8181 | kubectl port-forward --address 0.0.0.0 svc/argocd-server -n argocd 8080:443 > /var/log/argocd-port-forward.log 2>&1 &
